...
# BACKUP_KEY_PUB_FILE = Path.joinpath(Path.home(), '.backup_key.pem.pub')

DB_HOSTNAME = os.getenv("DB_HOSTNAME", "localhost")
DB_NAME = os.getenv("DB_NAME")
DB_USER = os.getenv("DB_USER")
S3_BUCKET_NAME = os.getenv("S3_BUCKET_NAME", "examquestions")
...
def dump_database():
    ...
    os.WEXITSTATUS(os.system(f"pg_dump -h {DB_HOSTNAME} -U {DB_USER} {DB_NAME} > /home/vlad/backup_db-{get_now_datetime_str()}.sql"))
